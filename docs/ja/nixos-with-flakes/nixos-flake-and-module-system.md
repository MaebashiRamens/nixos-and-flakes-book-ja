...
5. `modulesPath`: A parameter available only in NixOS, which is a path pointing to
   ...
   - It is defined in
     [nixpkgs/nixos/lib/eval-config-minimal.nix#L43](https://github.com/NixOS/nixpkgs/blob/nixos-25.11/nixos/lib/eval-config-minimal.nix#L43).
...
1. `specialArgs`: There are scattered mentions related to it in the NixOS Manual and the
   ...
   - NixOS Manual:
     [nixpkgs/nixos-25.11/nixos/doc/manual/development/option-types.section.md#L237-L244]
1. `_module.args`:
   - NixOS Manual:
...
[nixpkgs/nixos-25.11/nixos/doc/manual/development/option-types.section.md#L237-L244]:
  https://github.com/NixOS/nixpkgs/blob/nixos-25.11/nixos/doc/manual/development/option-types.section.md?plain=1#L237-L244
